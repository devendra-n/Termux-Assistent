...
tm=t.strftime('%I:%M %p')
os.system('clear')
os.system('figlet -f banner BHARGAV |lolcat')
os.system('echo "                          AI system" |lolcat')
os.system('echo "                                     -Made by Devendra" |lolcat')
os.system('mpv bhargav.mp3 |lolcat')
time.sleep(3)
os.system('clear')
os.system('figlet -f banner DEVENDRA |lolcat')
time.sleep(1)
